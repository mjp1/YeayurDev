...
(function($, window, document) {
	...
	*/
	...
	EmojiArea.createIcon = function(emoji, menu) {
		...
		var column = emoji[2];
		var name = emoji[3];
		var filename = $.emojiarea.assetsPath + '/images/emoji/emoji_spritesheet_!.png';
    var blankGifPath = $.emojiarea.assetsPath + '/images/emoji/blank.gif';
    ...
    $('.post-img-preview').after("<i class='emoji-picker-icon emoji-picker fa fa-smile-o " + this.options.popupButtonClasses + "' data-id='" + id + "' data-type='picker'></i>");
