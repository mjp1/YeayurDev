			...
			@if ($communityPosts->count())
			    @foreach ($communityPosts as $Posts)
				    <div class="main-user-post col-lg-3 col-md-4 col-sm-6 col-xs-12">
						<div class="thumbnail{{ $Posts->request_streamer ? ' request-streamer-thumbnail' : '' }}">
					        ...
					        <ul class="streamer-post-message-footer">
								...
								<li class="streamer-post-like-count">
									<i class="fa fa-smile-o streamer-post-like-count-img" aria-hidden="true"></i>
...
<!-- Include modal for response to "Request Streamer" feature -->

    <div class="modal fade" id="request-streamer-respnse-modal" tabindex="-1" role="dialog">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<span class="help-block">(This will show up as a post on the main page.)</span>
	      	<form role="form" method="post" action="#">
	      		<textarea class="form-control input-global" rows="5" name="" placeholder="Give your suggestion for streamers to check out."></textarea> 
	      	</form>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	        <button type="button" class="btn btn-global request-streamer-submit">Request</button>
	      </div>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
