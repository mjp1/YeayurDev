...
@section('content')
	...
	<div class="alert alert-warning text-center col-sm-8 col-sm-offset-2">If this is incorrect, sign out of Twitch and <a href="{{ route('index.public') }}">click here</a>.</div>
