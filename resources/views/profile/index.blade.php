...
@if (Auth::check())
	...
	<!-- STREAMER TOP VISITS SECTION -->
					...
					<div class="streamer-about-panel well">
						<h5>What I Stream</h5>
						@if ($user->id === Auth::user()->id && $user->UserType->count())
						...
						<div class="streamer-about-panel-wrapper">
							...
							<div class="streamer-about-item">
								@if (!$user->UserType->count())
									@if ($user->id === Auth::user()->id)
										<button class="btn btn-global edit-info-categories-btn">Add Stream Details</button>
									@else
